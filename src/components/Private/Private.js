...
export default connect(mapStateToProps, { getUserInfo })(Private)   // mapStateToProps passes in all of state from store. getUserInfo is only available to componentDidMount because it is within connect that connects to store.